...
namespace dash
{
    ...
    class AliasManager; // 添加AliasManager类前向声明
    ...
    private:
        ...
        std::unique_ptr<AliasManager> alias_manager_; // 添加AliasManager成员变量
    ...
    public:
         ...
         * @brief 获取别名管理器
         *
         * @return AliasManager* 别名管理器指针
         */
        AliasManager *getAliasManager() const;
